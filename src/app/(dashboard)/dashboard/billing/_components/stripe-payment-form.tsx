        ...
        <CardContent className="pt-6">
          <div className="flex flex-col space-y-4">
            ...
            <div className="text-xs text-muted-foreground space-y-2">
              <p>
                Payment is secure and encrypted. Stripe, a trusted provider, handles the transaction.
              </p>
              <p>
                Your payment details go directly to Stripe and never reach our servers.
              </p>
              <p>
                Credits are added immediately after successful payment and remain valid for {CREDITS_EXPIRATION_YEARS} years.
              </p>
            </div>
          </div>
        </CardContent>
